...
import ActionMoviesImgs from "./ActionMoviesImg";

type ActionMoviesProp = {
  actionMovies: [];
};

function ActionMovies({ actionMovies }: ActionMoviesProp) {
  ...
  return (
    <section className="mt-8 p-5 md:pl-13 relative group/slide-arrows group/see-more">
      <div className="flex items-center">
        ...
        <div className="text-white/50 cursor-pointer flex gap-1 items-center relative z-1 transition-all duration-300 ease-in-out opacity-0 -translate-x-10 group-hover/see-more:opacity-100 group-hover/see-more:translate-0">
          <Link to={"/see-more?category=action"} className="flex gap-1">
